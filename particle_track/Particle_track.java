...
public class Particle_track {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String datadir = "run_v316_201110";
        if (args.length == 14)
        {
        ...
        if (lochfyne==true)
        {
            datadir = "fvcom_output\\"+datadir+"\\output\\ptrack_dat";
            N = 1593;
            M = 943;
        }
        else
        {
            datadir = "dima_data\\"+datadir;
        }
        ...
        if (lochfyne == true)
        {
            nodexy = readFileDoubleArray("C:\\Users\\sa01ta\\Documents\\EFF\\mesh\\943dat\\nodexy.dat",M,2," ",true); // the original mesh nodes
            uvnode = readFileDoubleArray("C:\\Users\\sa01ta\\Documents\\EFF\\mesh\\943dat\\uvnode.dat",N,2," ",true); // the centroids of the elements
            trinodes = readFileIntArray("C:\\Users\\sa01ta\\Documents\\EFF\\mesh\\943dat\\trinodes.dat",N,3," ",true); // the corners of the elements
            neighbours = readFileIntArray("C:\\Users\\sa01ta\\Documents\\EFF\\mesh\\943dat\\neighbours.dat",N,3," ",true);
        }
        else
        {
            nodexy = readFileDoubleArray("D:\\"+datadir+"\\nodexy.dat",M,2," ",true);
            uvnode = readFileDoubleArray("D:\\"+datadir+"\\uvnode.dat",N,2," ",true);
            trinodes = readFileIntArray("D:\\"+datadir+"\\trinodes.dat",N,3," ",true);
            neighbours = readFileIntArray("D:\\"+datadir+"\\neighbours.dat",N,3," ",true);
        }
...
//        }       
    ...
    public static double[][] setupStartLocationsFyneFarms()
    {
        ...
        // Original ordering of Loch Fyne sites (no sensible order)
...
//        startlocs[8][0]=9; startlocs[8][1]=352401; startlocs[8][2]=6190933;
        ...
        // S->N ordering (reordering sites from above based on:
        // order_SN=[9 7 4 6 5 8 3 1 2];)
        
        startlocs[0][0]=1; startlocs[8][1]=352401; startlocs[8][2]=6190933;
        startlocs[1][0]=2; startlocs[6][1]=354969; startlocs[6][2]=6193169;
        startlocs[2][0]=3; startlocs[3][1]=354246; startlocs[3][2]=6194759;
        startlocs[3][0]=4; startlocs[5][1]=348880; startlocs[5][2]=6199380;
        startlocs[4][0]=5; startlocs[4][1]=352745; startlocs[4][2]=6201735;
        startlocs[5][0]=6; startlocs[7][1]=348606; startlocs[7][2]=6204475;
        startlocs[6][0]=7; startlocs[2][1]=353078; startlocs[2][2]=6206339;
        startlocs[7][0]=8; startlocs[0][1]=357420; startlocs[0][2]=6217200; 
        startlocs[8][0]=9; startlocs[1][1]=361834; startlocs[1][2]=6223063;
